# Generated by Powerlevel10k configuration wizard on 2023-01-31 at 13:08 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    mill_version            # mill enviroment (https://github.com/carlosedp/mill-zsh-completions)
